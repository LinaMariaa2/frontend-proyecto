            ...
            {cargando ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {invernaderos.length === 0 ? (
                        <div className="col-span-full text-center py-10 bg-white rounded-2xl border border-slate-200">
                            ...
                            <div>
                                ...
                                {responsableSeleccionado && !busquedaResponsable && (
                                    <div className="mt-2 bg-teal-50 text-teal-800 p-3 rounded-lg flex justify-between items-center">
                                        ...
                                        <button onClick={() => { setResponsableSeleccionado(null); setForm({ ...form, responsable_id: 0 }); }} className="text-teal-600 hover:text-teal-800"><X className="w-4 h-4"/></button>
                                    </div>
                                )}
                            </div>
                        </div>
