...
// Aplicamos el tipo a las props del componente.
...
const IconProgramacion = (props: SvgIconProps) => (
  <svg
    {...props}
...
const IconInvernaderos = (props: SvgIconProps) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
...
const IconAgenda = (props: SvgIconProps) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
...
const IconConfiguraciones = (props: SvgIconProps) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="container mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <DashboardCard
          ...
          href="/home/operario/programacion"
        />
        <DashboardCard
          title="Invernaderos"
