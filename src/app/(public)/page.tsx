...
export default function HomePage(): JSX.Element {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // ----------------------------------------------------
      // ⭐ CORRECCIÓN: La ruta no incluye "/crear"
      // ----------------------------------------------------
  ...
  return (
    <div className="bg-slate-50 font-sans">
      ...
      <main>
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-lg w-full relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <input
                  type="text"
                  name="nombre_visitante" // ⭐ Corregido: El backend espera 'nombre_visitante'
        ...
        {/* --- Resto de secciones (features, beneficios, stack, etc) --- */}
        {/* ... lo que ya tenías abajo ... */}
      </main>
